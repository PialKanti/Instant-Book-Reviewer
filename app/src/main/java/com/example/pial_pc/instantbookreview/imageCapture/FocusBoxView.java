package com.example.pial_pc.instantbookreview.imageCapture;
...
import com.example.pial_pc.instantbookreview.R;
...
public class FocusBoxView extends View {
    ...
    private void updateBoxRect(int dW, int dH) {
        ...
        int topOffset = (ScrRes.y - newHeight) / 10;
